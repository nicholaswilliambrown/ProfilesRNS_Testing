...
namespace API_test
{
    class Program
    {
        ...
        static int Main(string[] args)
        {
            ...
            {
                case "GET":
                    downloadFileFromPath(args[1], args[2]);
                    break;
                case "TESTPRNS":
                ...
                case "LINKS":
                    ...
                    break;
                case "QUICKLINKS":
                    string baseURI2 = getArg(args, "-b");
                    makeQuickLinksPage(baseURI2, database);
                    break;
                case "REPLACE":
                    string inputFile = getArg(args, "-i");
                    string outputFile = getArg(args, "-o");
                    string replace = getArg(args, "-r");
                    string replaceWith = getArg(args, "-w");
                    replaceInFile(inputFile, outputFile, replace, replaceWith);
                    break;
                default:
        ...
        static void downloadFileFromPath(string path, string URL)
        {
        ...
        static void makeQuickLinksPage(string baseURI, string database)
        {
            string sqlConnectionString = "Data Source=(local);Initial Catalog=" + database + ";User ID=App_Profiles10;Password=Password1234";
            int commandTimeOut = 500;
            SqlConnection dbconnection = new SqlConnection(sqlConnectionString);
            SqlCommand dbcommand = new SqlCommand(
                //--People
                "select top 5 '" + baseURI + "/display/' + convert (nvarchar(50), NodeID) as url from [RDF.Stage].[InternalNodeMap] where class = 'http://xmlns.com/foaf/0.1/Person'" +
                //--People with concepts
                "union select top 5 '" + baseURI + "/display/' + convert (nvarchar(50), NodeID) + '/Network/ResearchAreas' as url from [RDF.Stage].[InternalNodeMap] where class = 'http://xmlns.com/foaf/0.1/Person' and internalID in (select personid from [Profile.Cache].[Concept.Mesh.Person])" +
                "union select top 5 '" + baseURI + "/display/' + convert (nvarchar(50), NodeID) + '/network/researchareas/categories' as url from [RDF.Stage].[InternalNodeMap] where class = 'http://xmlns.com/foaf/0.1/Person' and internalID in (select personid from [Profile.Cache].[Concept.Mesh.Person])" +
                "union select top 5 '" + baseURI + "/display/' + convert (nvarchar(50), NodeID) + '/network/researchareas/timeline' as url from [RDF.Stage].[InternalNodeMap] where class = 'http://xmlns.com/foaf/0.1/Person' and internalID in (select personid from [Profile.Cache].[Concept.Mesh.Person])" +
                "union select top 5 '" + baseURI + "/display/' + convert (nvarchar(50), NodeID) + '/network/researchareas/details' as url from [RDF.Stage].[InternalNodeMap] where class = 'http://xmlns.com/foaf/0.1/Person' and internalID in (select personid from [Profile.Cache].[Concept.Mesh.Person])" +
                "union select top 5 '" + baseURI + "/display/' + convert (nvarchar(50), NodeID) + '/network/researchareas/cloud' as url from [RDF.Stage].[InternalNodeMap] where class = 'http://xmlns.com/foaf/0.1/Person' and internalID in (select personid from [Profile.Cache].[Concept.Mesh.Person])" +
                "union select top 5 '" + baseURI + "/display/' + convert (nvarchar(50), NodeID) + '/Network/SimilarTo' as url from [RDF.Stage].[InternalNodeMap] where class = 'http://xmlns.com/foaf/0.1/Person' and internalID in (select personid from [Profile.Cache].[Concept.Mesh.Person])" +
                "union select top 5 '" + baseURI + "/display/' + convert (nvarchar(50), NodeID) + '/network/similarto/map' as url from [RDF.Stage].[InternalNodeMap] where class = 'http://xmlns.com/foaf/0.1/Person' and internalID in (select personid from [Profile.Cache].[Concept.Mesh.Person])" +
                "union select top 5 '" + baseURI + "/display/' + convert (nvarchar(50), NodeID) + '/network/similarto/details' as url from [RDF.Stage].[InternalNodeMap] where class = 'http://xmlns.com/foaf/0.1/Person' and internalID in (select personid from [Profile.Cache].[Concept.Mesh.Person])" +
                "union select top 5 '" + baseURI + "/display/' + convert (nvarchar(50), NodeID) + '/network/similarto/list' as url from [RDF.Stage].[InternalNodeMap] where class = 'http://xmlns.com/foaf/0.1/Person' and internalID in (select personid from [Profile.Cache].[Concept.Mesh.Person])" +
                //--People with CoAuthors
                "union select top 5 '" + baseURI + "/display/' + convert (nvarchar(50), NodeID) + '/Network/CoAuthors' as url from [RDF.Stage].[InternalNodeMap] where class = 'http://xmlns.com/foaf/0.1/Person' and internalID in (select personid1 from [Profile.Cache].[SNA.Coauthor])" +
                "union select top 5 '" + baseURI + "/display/' + convert (nvarchar(50), NodeID) + '/network/coauthors/map' as url from [RDF.Stage].[InternalNodeMap] where class = 'http://xmlns.com/foaf/0.1/Person' and internalID in (select personid1 from [Profile.Cache].[SNA.Coauthor])" +
                "union select top 5 '" + baseURI + "/display/' + convert (nvarchar(50), NodeID) + '/network/coauthors/radial' as url from [RDF.Stage].[InternalNodeMap] where class = 'http://xmlns.com/foaf/0.1/Person' and internalID in (select personid1 from [Profile.Cache].[SNA.Coauthor])" +
                "union select top 5 '" + baseURI + "/display/' + convert (nvarchar(50), NodeID) + '/network/coauthors/cluster' as url from [RDF.Stage].[InternalNodeMap] where class = 'http://xmlns.com/foaf/0.1/Person' and internalID in (select personid1 from [Profile.Cache].[SNA.Coauthor])" +
                "union select top 5 '" + baseURI + "/display/' + convert (nvarchar(50), NodeID) + '/network/coauthors/timeline' as url from [RDF.Stage].[InternalNodeMap] where class = 'http://xmlns.com/foaf/0.1/Person' and internalID in (select personid1 from [Profile.Cache].[SNA.Coauthor])" +
                "union select top 5 '" + baseURI + "/display/' + convert (nvarchar(50), NodeID) + '/network/coauthors/details' as url from [RDF.Stage].[InternalNodeMap] where class = 'http://xmlns.com/foaf/0.1/Person' and internalID in (select personid1 from [Profile.Cache].[SNA.Coauthor])" +
                "union select top 5 '" + baseURI + "/display/' + convert (nvarchar(50), NodeID) + '/network/coauthors/list' as url from [RDF.Stage].[InternalNodeMap] where class = 'http://xmlns.com/foaf/0.1/Person' and internalID in (select personid1 from [Profile.Cache].[SNA.Coauthor])" +
                //--Organizations (these should render, but are not very interesting)
                "union select top 5 '" + baseURI + "/display/' + convert (nvarchar(50), NodeID) as url from [RDF.Stage].[InternalNodeMap] where class = 'http://xmlns.com/foaf/0.1/Organization'" +
                //--Concepts
                "union select top 5 '" + baseURI + "/display/' + convert (nvarchar(50), NodeID) as url from [RDF.Stage].[InternalNodeMap] where class = 'http://www.w3.org/2004/02/skos/core#Concept'" +
                //--Publications
                "union select top 5 '" + baseURI + "/display/' + convert (nvarchar(50), NodeID) as url from [RDF.Stage].[InternalNodeMap] where class = 'http://vivoweb.org/ontology/core#InformationResource'" +
                //--Search
                "union select top 5 '" + baseURI + "/search/default.aspx?searchtype=people&lname=&searchfor=asthma&exactphrase=false&institution=&classuri=http://xmlns.com/foaf/0.1/Person&perpage=15&offset=0'  as url" +
                "union select top 5 '" + baseURI + "/search/default.aspx?searchtype=everything&searchfor=asthma&exactphrase=false' as url"
                );
        ...
        static void replaceInFile(string inputFile, string outputFile, string replace, string replaceWith)
        {
